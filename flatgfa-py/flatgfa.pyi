...
class ChunkEvent:
    ...
    handle:Handle
    range: list[int]
    def __getseq__(self)-> None:...
    def __getindex__(self)-> None:...
    def __gethandle__(self)-> None:...
    def __getrange__(self)-> None:...
...
class GAFLine:
    name:str
    chunk_List: list[ChunkEvent]
    def __get_name__(self)-> str:...
    def __get_chunk_list__(self)-> list[ChunkEvent]:...
    def __get_seg__(self)-> str:...
    def __get_sequence__(self)-> str:...
    # def __toPathChunker__(self)->PathChunker:...
...
class FlatGFA:
    ...
    def depth(self)-> None: ...
    # New method for look up
    def load_gaf(self,gaf:str)->GAFParser:...
