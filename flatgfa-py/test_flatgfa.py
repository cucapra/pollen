...
def test_toc(gfa: FlatGFA)
def test_paths(gfa: FlatGFA)
def test_stats(gfa: FlatGFA, s: Optional[bool], l: Optional[bool])
def test_position(gfa: FlatGFA, pos: str)
def test_chop(gfa: FlatGFA, )
def test_depth(gfa: FlatGFA)
def test_extract(gfa: FlatGFA)
    
    def toc(gfa: FlatGFA) -> None: ...
def paths(gfa: FlatGFA) -> None: ...
def stats(gfa: FlatGFA, s: Optional[bool], l: Optional[bool]) -> None: ...
def position(gfa: FlatGFA, pos: str) -> None: ...
def chop(gfa: FlatGFA, c: int) -> FlatGFA: ...
def depth(gfa: FlatGFA) -> None: ...
def extract(
        gfa: FlatGFA, seg_id: int, link_dist: int, subpaths_dist: int, iters: int
    ) -> FlatGFA: ...