...
def node_depth(max_nodes=MAX_NODES, max_steps=MAX_STEPS, max_paths=MAX_PATHS):
    ...
    cells = [
        ...
        Cell(
            paths_on_node, stdlib.mem_d1(1, ptc_size, path_id_width), is_external=True
        ),
    ...
    wires = [
        ...
        CombGroup(
            ...
            [
                ...
                Connect(
                    CompPort(idx_neq, "right"), ConstantPort(steps_width, max_steps - 1)
                ),
            ],
        ),
        # Node depth wires
        Group(
            ...
            [
                Connect(
                    CompPort(paths_to_consider, "addr0"), CompPort(path_id_reg, "out")
                ),
                Connect(
                    CompPort(depth_temp, "in"), CompPort(paths_to_consider, "read_data")
                ),
        ...
        Group(
            ...
            [
                ...
                Connect(
                    HolePort(CompVar("inc_depth"), "done"), CompPort(depth, "done")
                ),
            ],
        ),
        Group(
            ...
            [
                ...
                Connect(
                    HolePort(CompVar("write_depth"), "done"),
        ...
        CombGroup(
            ...
            [
                ...
                Connect(
                    CompPort(uniq_idx_neq, "right"), ConstantPort(path_id_width, 0)
                ),
            ],
        ),
        Group(
            ...
            [
                ...
                Connect(
                    CompPort(uniq_idx_adder, "right"), ConstantPort(path_id_width, 1)
                ),
        ...
        Group(
            ...
            [
                ...
                Connect(
                    CompPort(uniq_and_reg_l, "in"), CompPort(paths_on_node, "read_data")
                ),
        ...
        Group(
            ...
            [
                Connect(
                    CompPort(paths_to_consider, "addr0"), CompPort(uniq_idx, "out")
                ),
                Connect(
        ...
        Group(
            ...
            [
                ...
                Connect(
                    HolePort(CompVar("store_uniq"), "done"),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-a",
        "--auto-size",
        help="automatically infer the dimensions of the hardware accelerator",
    )
    parser.add_argument(
        "-n",
        "--max-nodes",
